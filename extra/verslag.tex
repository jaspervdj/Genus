...
dezelfde pariteit bezitten ook gelden dat $f_1 + 1 > m$. We kunnen dus nog iets
...
wortel van de \emph{breadth-first search} gevonden. Door een
\emph{breadth-first search} te starten vanuit elke top, bepalen we zo het
\emph{girth} van de graaf. Dit algoritme is ge\"implementeerd in de klasse
\verb#FindGirth#.
